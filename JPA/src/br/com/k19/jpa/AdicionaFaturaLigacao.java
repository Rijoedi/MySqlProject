...
public class AdicionaFaturaLigacao {
	public static void main(String[] args) {
		...
		System.out.println("Digite o tempo de duracao da ligacao: ");
		...
		System.out.println("Ligacao cadastrada com id: " + ligacao1.getId());
		System.out.println("Ligacao cadastrada com id: " + ligacao2.getId());
